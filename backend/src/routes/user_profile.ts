...
import { changeAvatar, changePassword, getMyProfile, getUserProfile, searchUser, updateMyProfile } from "../handlers/user_profile.js";
...
router.get('/users/search', authLimiter, authenticateToken, searchUser);//deplacer
