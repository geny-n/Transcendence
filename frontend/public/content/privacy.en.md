...
- **Cookies** are small files placed on Your device containing browsing data.
...
- **You** means the user accessing the Service.
...
You can refuse cookies through your browser settings.
...
- accounts: duration + up to 24 months
...
Your data may be transferred to other countries.
...
We will notify users of changes and update the date.
