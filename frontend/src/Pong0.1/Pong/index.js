...
function segmentIntersectsRect(x1,y1,x2,y2,rect) {
    ...
    // edges
    if (segIntersectsSeg(x1,y1,x2,y2, rect.left, rect.top, rect.right, rect.top)) return true;
    if (segIntersectsSeg(x1,y1,x2,y2, rect.right, rect.top, rect.right, rect.bottom)) return true;
    if (segIntersectsSeg(x1,y1,x2,y2, rect.right, rect.bottom, rect.left, rect.bottom)) return true;
    if (segIntersectsSeg(x1,y1,x2,y2, rect.left, rect.bottom, rect.left, rect.top)) return true;
    return false;
}
